...
There is no standard formula for harm to population health. We are going to arbitrarily create the follwing equation to calculate harm per event: 

  $Harm = \sum_{i=1}^{n} (2*Fatalities_{i} + Injuries_{i})/n$

Where n is the number of occurences of that event. Again, as this is an arbitrarily assigned equation, we have decided to weight the fatalities in our equation. Most might agree that fatalities are more harmful to population health than injuries.
