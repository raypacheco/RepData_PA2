...
```{r}
ggplot(top15DMG, aes(EVTYPE, TOTALDMG/1000000, order=TOTALDMG)) + geom_bar(stat="identity", fill="red") + coord_flip() + labs(x = "", y="Total Damage (in millions)", title="Total Damage by Event Type")
```